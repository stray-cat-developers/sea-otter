...
internal class ExtensionKtTest {
    ...
    fun base64SafeUrl() {
        ...
        val encodedBase64SafeUrl = Base64.getUrlEncoder().encodeToString(base64.toByteArray())

        println(encodedBase64SafeUrl)

        val encodedBase64 = String(Base64.getUrlDecoder().decode(encodedBase64SafeUrl))
